...
class View2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print(" 1. view 2 --->> func viewDidLoad()")
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print(" 2. view 2 --->> func viewWillAppear(_ animated: Bool)")
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        print(" 3. view 2 --->> func viewDidAppear(_ animated: Bool)")
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        print(" 4. view 2 --->> func viewWillDisappear(_ animated: Bool)")
    }
    ...
    override func viewDidDisappear(_ animated: Bool) {
         ...
         */
        print(" 5. view 2 --->> func viewDidDisappear(_ animated: Bool)")
    }
}
